...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://calm-journey-36314.herokuapp.com',
...
var restaurantEvents = __webpack_require__(15);
...
var onAddRestaurant = function onAddRestaurant(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.addRestaurant(data).then(ui.addRestaurantSuccess).then(function () {
    return onShowRestaurants(event);
...
var onUpdateRestaurant = function onUpdateRestaurant(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateRestaurant(data).then(ui.udpateRestaurantSuccess).then(function () {
    return onShowRestaurants(event);
...
var onDeleteRestaurant = function onDeleteRestaurant(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.deleteRestaurant(data).then(ui.deleteRestaurantSuccess)
  // adding new .then
  .then(function () {
    return onShowRestaurants(event);
...
var onShowRestaurants = function onShowRestaurants(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.showRestaurants(data).then(ui.showRestaurantsSuccess).catch(ui.showRestaurantsFailure);
};
...
var onPickRestaurant = function onPickRestaurant(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.pickRestaurant(data).then(ui.pickRestaurantSuccess).catch(ui.pickRestaurantFailure);
};
...
var showRestaurantsTemplate = __webpack_require__(17);

var addRestaurantSuccess = function addRestaurantSuccess(data) {
  // console.log(data)
...
var addRestaurantFailure = function addRestaurantFailure() {
...
var udpateRestaurantSuccess = function udpateRestaurantSuccess(data) {
  // console.log(data)
...
var udpateRestaurantFailure = function udpateRestaurantFailure() {
...
var showRestaurantsSuccess = function showRestaurantsSuccess(data) {
...
var showRestaurantsFailure = function showRestaurantsFailure() {
...
// For eventual randomizer
var pickRestaurantSuccess = function pickRestaurantSuccess(data) {}
...
// For eventual randomizer
;var pickRestaurantFailure = function pickRestaurantFailure() {
  //   $('#message').html(`<div class="alert alert-danger" role="alert"> Nothing to look at here.</div>`)
  //   $('#message').css('text-align', 'center')
  //   $('form').trigger('reset')
  //   $('#no-show').html('')
...
module.exports = {
  ...
  addRestaurantFailure: addRestaurantFailure,
  udpateRestaurantSuccess: udpateRestaurantSuccess,
  udpateRestaurantFailure: udpateRestaurantFailure,
  deleteRestaurantSuccess: deleteRestaurantSuccess,
  deleteRestaurantFailure: deleteRestaurantFailure,
  showRestaurantsSuccess: showRestaurantsSuccess,
  showRestaurantsFailure: showRestaurantsFailure,
  pickRestaurantSuccess: pickRestaurantSuccess,
  pickRestaurantFailure: pickRestaurantFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <h1 data-id=\""
    ...
    + "\" class=\"show-restaurants\">\n  </h1>\n  <div data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.restaurant_name : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n<div>\n      Cuisine:\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.cuisine : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </div>\n\n  <!-- "
    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"update-restaurant","data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "> -->\n  <div class=\"update-restaurant-form\">\n    <form class=\"update-restaurant\">\n      <fieldset>\n        <input type=\"hidden\" name=\"restaurant[id]\" autocomplete=\"restaurant id\" placeholder=\"Restaurant ID\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n\n        <input type=\"text\" name=\"restaurant[restaurant_name]\" autocomplete=\"restaurant\" placeholder=\"New Restaurant Name\" required>\n\n        <input type=\"text\" name=\"restaurant[cuisine]\" autocomplete=\"cuisine\" placeholder=\"Update Cuisine\" required>\n\n        <input class=\"button2\" type=\"submit\" value=\"Update\">\n      </fieldset>\n    </form>\n  </div>\n  <div>\n<form class=\"delete-restaurant\">\n<fieldset>\n  <input type=\"hidden\" name=\"restaurant[id]\" autocomplete=\"restaurant id\" placeholder=\"Restaurant ID\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <input class=\"button2\" type=\"submit\" value=\"Delete Restaurant\">\n</fieldset>\n</form>\n</div>\n\n\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "        <h3>"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.restaurant_name : stack1), depth0))
    + "</h3>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "        No name information.\n";
},"6":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "        "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.cuisine : stack1), depth0))
    + "\n";
},"8":function(container,depth0,helpers,partials,data) {
    return "        This cuisine is... not here?\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div class=\"close-list\">\n  <form class=\"close-restaurant-list\">\n    <fieldset>\n      <input class=\"button\" type=\"submit\" value=\"Close List\">\n    </fieldset>\n  </form>\n</div>\n\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<h3 data-id=\"\" class=\"update-restaurant\">Update Restaurant</h3>\n\n<form class=\"update-restaurant\">\n  <fieldset>\n      <input type=\"hidden\" name=\"restaurant[id]\" autocomplete=\"restaurant id\" placeholder=\"Restaurant ID\" value=\""
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n\n\n    <input type=\"text\" name=\"restaurant[restaurant_name]\" autocomplete=\"restaurant\" placeholder=\"Restaurant Name\" required>\n\n    <input type=\"text\" name=\"restaurant[cuisine]\" autocomplete=\"cuisine\" placeholder=\"Cuisine\" required>\n\n    <input class=\"button\" type=\"submit\" value=\"Update\">\n  </fieldset>\n</form>\n";
},"useData":true});
...
var addRestaurant = function addRestaurant(data) {
...
var showRestaurants = function showRestaurants(data) {
...
var pickRestaurant = function pickRestaurant(data) {
  // return $.ajax({
  //   url: config.apiUrl + '/restaurants',
  //   headers: {
  //     contentType: 'application/json',
...
module.exports = __webpack_require__.p + "da3052a7b1da637fab3852535a05d1c8.jpg";
